...
comptabilisée en~$t+1$. En pratique, l'exercice d'imposition~$t+1$ est établi sur
les revenus de la période imposable~$t$, si bien que l'impôt afférent à l'année~$t$
...
\end{equation}
Le taux est de 8\,\% pour l'épargne-pension et de 10\,\% (cf.~\hyperref[subsub:taxe_anticipative_ep]{l'épargne-pension} et
\hyperref[subsub:taxe_anticipative_elt]{l'épargne à long terme}) pour l'épargne à
...
brut, puis le versement de l'année est ajouté. Comme dit précédemment,
...
calcul du capital final net. \hl{demander à arsène}
\begin{equation}
...
\begin{equation}
  \text{TCT}_t =
  \begin{cases}
    \min\!\Bigl(R_t \times 0{,}15\%,\; 10\% \times (R_t - 1\,000\,000)\Bigr)
      & \text{si } R_t > 1\,000\,000~\text{€}, \\
    0
      & \text{sinon.}
  \end{cases}
\end{equation}
...
à 1\,200\,000~€. La taxe brute serait de $1\,200\,000 \times 0{,}15\,\% =
1\,800$~€ et le plafond de $10\,\% \times (1\,200\,000 - 1\,000\,000) = 20\,000$~€.
La taxe due est donc $\min(1\,800;\,20\,000) = 1\,800$~€.}
\end{quote}
...
\begin{quote}
\textit{Exemple~: À 65~ans, Antoine liquide son compte-titres dont la réserve
