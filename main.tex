...
\hl{soit ici soit ce qui suit plus loin est redondant et doit être supprimé}
...
est un contrat dont la prestation de l'assureur correspond,
au dénouement du contrat, à un certain nombre de parts
acquises dans un ou plusieurs fonds d'investissement
gérés par l'assureur ou par un autre organisme financier.
Ce nombre de parts est garanti par l'assureur, mais non
leur valeur, le risque financier étant intégralement
supporté par le preneur d'assurance. La prime unique ou
les primes périodiques sont ensuite investies 
(après déduction des éventuels taxes et
chargements) dans ces
fonds, et la rentabilité du contrat dépend entièrement
de la performance des actifs sous-jacents
\cite[p.~131-132]{Binon2016}.

Les fonds d'investissement
suivent des stratégies prédéfinies, orientant
...
\hl{je pense que ce bloc peut être retiré ou alors on 
en parle de manière anecdotique car dans le tfe on parle d etf
donc ça reste un niveau de risque relativement élevé}
...
\hl{peut être retirer aussi la dernière phrase}
...
\hl{5\% donc incohérence avec la suite ?}
...
\hl{donc surement remonter ça au dessus}
