...
et d'un référentiel de capitalisation stable sur l'ensemble de la simulation\footnote{Les
données publiées par la Banque nationale de Belgique couvrent des maturités allant jusqu'à
30~ans. Pour les durées résiduelles supérieures à 30~ans, le taux OLO à 30~ans est
retenu par convention.}.

\hl{nécessaire en fait puisque c est dit en bas ?}
