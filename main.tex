...
courtage s'élèvent à 0{,}5\,\% ($= 5$~€) et la TOB à 1{,}32\,\% ($= 13{,}20$~€).
Ces 18{,}20~€ sortent de sa poche à chaque versement sans jamais entrer dans la
...
Chaque année, des frais de garde sont prélevés proportionnellement à la valeur
de la réserve. Ils réduisent directement la réserve et sont également
comptabilisés comme flux sortants dans le calcul du capital final net.
\begin{equation}
...
Avec des frais de garde de 0{,}2\,\%, il supporte $10\,000 \times 0{,}002 = 20$~€
de frais cette année-là. Répétés et croissants à mesure que la réserve grossit,
ces frais représentent un coût cumulé important une fois ramenés à l'échéance.}
\end{quote}
...
brut. Les frais de garde sont ensuite prélevés sur la valeur capitalisée, puis
le versement de l'année est crédité.
\begin{align}
  \widetilde{R}_t &= R_{t-1} \times (1 + r) \notag \\
  R_t             &= \widetilde{R}_t - \text{FraisGarde}_t + v
\end{align}

\begin{quote}
\textit{Exemple~: Antoine dispose d'une réserve de 10\,000~€ en début d'année,
placée à 5\,\%. Elle grossit à $10\,000 \times 1{,}05 = 10\,500$~€, puis les
frais de garde de 20~€ sont prélevés~: 10\,480~€. Le versement annuel de 1\,000~€
porte ensuite la réserve à 11\,480~€ en fin d'année. Cette logique se répète
jusqu'à l'échéance.}
\end{quote}
