...
réalise~--- le décès ou la survie de l'assuré à une
...
fonds d'investissement~: la valeur fluctue selon la
performance des actifs sous-jacents, aucun rendement ni
capital n'étant garanti \cite[p.~130-132]{Binon2016}.

Juridiquement, les primes versées deviennent la propriété
de l'assureur, qui les intègre à son passif. En contrepartie,
le preneur détient un droit de créance
sur lequel il peut exercer différentes
prérogatives~: rachat, réduction, avance, mise en gage ou
cession \cite[p.~366-367]{Binon2016}.
...
proposés varie sensiblement d'un assureur à l'autre selon
les objectifs de rendement, la zone géographique ou
encore les préférences thématiques ou éthiques \cite[p.~133]{Binon2016}.

Sur le plan juridique, l'assureur garantit le nombre d'unités
à verser au dénouement, mais non leur valeur~: le risque
financier est intégralement supporté par le preneur
d'assurance \cite[p.~132]{Binon2016}.

Les versements sont en principe facultatifs~: le défaut de
paiement entraîne soit la résiliation du contrat, soit la
réduction des prestations, sans qu'aucune exécution forcée
ne soit possible. Certains contrats imposent toutefois un
versement minimal ou se limitent à une prime unique
\cite[p.~333-335]{Binon2016}. \hl{à compléter plus tard + parler des primes, versements annuels ? mensuels ?}

\subsubsection{Classification des risques}

La valeur du contrat fluctue au gré des marchés~: une
progression des cours apprécie le capital constitué, tandis
qu'une dégradation peut l'éroder jusqu'à perte totale.
\hl{faire le lien avec la suite}

Les fonds liés aux contrats de branche~23 constituent des
Packaged Retail and Insurance-based Investment Products
(PRIIPs) \hl{expliquer au début ?} au sens du règlement (UE)
n\textsuperscript{o}~1286/2014, ce qui impose la remise
d'un document d'informations clés (KID) au souscripteur
avant toute souscription \cite{Reg1286-2014}.
...
plusieurs composantes. Une taxe sur les
...
la réserve, à deux niveaux~: celui du fonds interne géré
par l'assureur, puis celui des actifs sous-jacents
\cite{wikifin_a}.
...
Le CIR qualifie d'intérêts imposables les revenus des
contrats d'assurance-vie dans deux hypothèses~: les
contrats à rendement garanti (branche~21) et les contrats
liés à des fonds d'investissement dont la souscription
comporte des engagements déterminés quant à la durée, au
montant ou au taux de rendement \cite[art.~19]{cir92_2025}.

Or, les contrats de branche~23 standard ne comportant
aucun de ces engagements, les revenus à la sortie ne sont
pas qualifiés d'intérêts au sens de l'article~19 et
échappent au précompte mobilier, quelle que soit la durée
du contrat.

\hl{comme nous le verrons il y a des variantes pour ep et el ?}

Les parts acquises sont conservées sur un compte-titres
global géré par l'assureur. Lorsque sa valeur dépasse un
million d'euros, la taxe sur les comptes-titres (TCT) de
0,15\,\% est due par l'assureur, qui peut en répercuter le
coût sur les preneurs selon ses conditions générales
\cite{monastuces2021tact, spf_tct_faq}.

\subsubsection{Garanties et protection du souscripteur}

Le mécanisme belge de protection des dépôts ne couvre que
les contrats de branche~21, à concurrence de 100\,000~euros
par preneur et par assureur.

Les assurances-vie de la branche~23 sont expressément exclues
de ce mécanisme~: en cas de faillite de la compagnie
d'assurance, le capital investi est exposé au risque de
perte, sans filet de sécurité institutionnel comparable
\cite[p.~522-523]{Binon2016}.

\subsection{L'épargne-pension}
\subsubsection{Définition et cadre réglementaire}

L'épargne-pension est une enveloppe fiscale permettant, via
un contrat d'assurance-vie des branches~21 ou~23, de se
constituer un capital complémentaire pour la retraite. Les
versements ouvrent droit à une réduction d'impôt accordée
...
pouvant excéder l'ensemble des réductions d'impôt obtenues.
...
Le souscripteur peut choisir de ne pas les revendiquer, ce
qui peut être judicieux pour les contribuables à faibles
revenus. La décision doit toutefois être prise avec
...
L'épargne à long terme est une enveloppe fiscale analogue,
permettant via un contrat d'assurance-vie des branches~21
ou~23 de se constituer un capital complémentaire pour la
retraite tout en bénéficiant d'une réduction d'impôt
\cite[p.~115-116]{Binon2016}. Contrairement à l'épargne-pension, les versements
restent soumis à la taxe sur les opérations d'assurance de
2\,\%, qui réduit d'autant le montant investi.
...
souscripteur~; les modifications intervenant après 65~ans
ne sont pas assimilées à une souscription antérieure.
