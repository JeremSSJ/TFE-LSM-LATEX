...
Les heatmaps
correspondantes sont aussi présentées en annexe pour une meilleure lisibilité
(figures~\ref{fig:ann_elt_frais_reel_sans_taxe}, \ref{fig:ann_elt_frais_reel_avec_taxe}).
...
La spécificité tient au barème de la réduction d'impôt~: 30\,\% pour les
versements jusqu'à 1\,050~€, puis 25\,\% pour la tranche allant jusqu'au
plafond de 1\,350~€. Comme 25\,\% de 1\,051~€ est inférieur à 30\,\%
de 1\,050~€, l'avantage fiscal cumulé décroche dès que l'on franchit ce
seuil. Il en résulte, dans de nombreuses cellules, un seuil de
croisement structurel à 1\,050~€~: l'EP domine jusqu'à ce niveau de
versement, puis le compte-titres reprend la tête.
...
intermédiaire, absente pour l'ELT dont le taux est uniforme, élargit
...
concentrent aux rendements élevés et horizons longs, et elles se
contractent du scénario~A au scénario~C. Le seuil de croisement à
...
8\,\% contre 10\,\%), la plage de versements est plafonnée à 1\,350~€,
