...
\textbf{Rendement annuel brut constant.} Le taux de rendement est supposé identique
chaque année pour les deux véhicules. Les marchés financiers sont en réalité
volatils~; cette hypothèse est nécessaire pour que la comparaison soit déterministe
et systématique sur l'ensemble des profils simulés.

\textbf{Versements annuels constants.} Les versements sont annuels et identiques d'une
année à l'autre. Un versement mensuel aurait introduit une fréquence de
capitalisation supplémentaire sans modifier la logique de comparaison~; le versement
annuel est par ailleurs cohérent avec le cadre légal des contrats branche~23, dont
les primes peuvent être uniques ou périodiques. L'inflation et l'évolution du revenu
de l'investisseur ne sont pas modélisés. Par ailleurs, le montant versé chaque année
est supposé intégralement investi dans l'actif, indépendamment du cours de celui-ci
au moment de l'achat. En pratique, le prix d'une part d'ETF fluctue dans le temps,
de sorte que le même montant permet d'acquérir un nombre de parts variable d'une
année à l'autre. Cette abstraction reste toutefois acceptable dans la mesure où de
nombreux courtiers proposent aujourd'hui l'achat de fractions de parts, permettant
d'investir n'importe quel montant sans contrainte liée à la valeur d'une part entière.

\textbf{Effort d'épargne constant jusqu'à l'échéance.} La simulation exclut tout rachat
...
\textbf{Horizon commun fixé à 65~ans.} Le régime fiscal de l'épargne-pension prévoit que
...
\textbf{Âge de début plafonné à 55~ans.} La simulation n'inclut que des profils dont les
...
\textbf{Portefeuille entièrement investi en actions via un ETF accumulant.} L'investisseur
...
\textbf{Abstraction du spread et des coûts d'exécution.} Lors de chaque transaction,
...
\textbf{Frais constants par scénario.} Les frais d'entrée et de gestion sont fixes dans un
scénario donné~; leur évolution dans le temps n'est pas modélisée.

\textbf{Taxe sur les comptes-titres couverte par les frais de gestion de la branche~23.}
...
\textbf{Fiscalité figée au moment de la rédaction.} La réglementation fiscale est celle en
vigueur au moment de la rédaction. Tout changement législatif futur n'est pas pris en
compte.

\textbf{Comparaison en capital final net à l'échéance.} La comparaison est conduite en
...
\textbf{Absence de risque de contrepartie.} Les deux instruments sont supposés exempts de
tout risque de défaut ou de faillite de l'assureur ou du courtier.

\textbf{Méthode d'exonération des plus-values simplifiée.} L'exonération des plus-values
...
\textbf{Remboursement fiscal décalé d'un an.} La réduction d'impôt liée aux versements
...
\textbf{Réduction d'impôt systématiquement déclarée.} La simulation suppose que
...
\textbf{Épargne à long terme~: plafond de déduction atteint chaque année.} Pour l'ELT,
...
\textbf{Flux annexes traités comme certains et taux OLO fixes.} Les économies fiscales
...
\textbf{TOB au taux de 0,12\,\%.} La simulation applique la taxe sur les opérations de
