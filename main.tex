...
\hl{quand taxe plus pour scenario A, alors victoire quasi totale d elt
sauf à certains niveaux très bas de versement,  problament qu éco
fiscale trop faible pas suffisante pour compenser intérêts composés
...
des places par rapport au cas sans taxe sur les pv car forcément
taxe pv vient donner un handicap supplémentaire au compte titre

et donc cette fois toujours sur des horizons long et rendements élevés
les couts pris sur l elt qui sont pris sur le côté sur l elt sont trop 
préjudiciables et font que compte titres eux profitent mieux de l intérêt composé
}
