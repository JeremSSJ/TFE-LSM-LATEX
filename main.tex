...
constituant une borne supérieure défavorable à ce dernier 
...
\hl{pour scenario A juste TOA 2 pourcents qui réduit directement les versements

+ 10 pourcents anticipative à 60 ans 
mais pas d'autres frais sur prime ni récurrent sur réserve
ce qui grignote moins l avantage des éco fiscale et permet une bonne capitalisation

à l opposé sur des horizons plus longs et rendements plus élevés
les intérêts composés du compte titres (qui ne subit toujours pas de frais et taxe pv )
supplantent tous les avantages de l elt

}


\hl{pour scenario c avec frais majoré donc 
frais elt transposés à ct l implication principale 
est pour laquelle les comptes titres arrivent encore à gagner est 
que les frais sont ponctionnés sur le côté 
et ne réduisent ni les versements ni le capital en train de s accumuler

et donc ils sont encore avantageux sur horizons long et rendements élevés (tendance qu on
remarque partout)

mais à rendement plus faible économies fiscales donnent trop l avantage à l elt 
