...
\hl{coût opportunité des flux annexes}
...
et d'un référentiel de capitalisation stable sur l'ensemble de la simulation\footnote{source}.

\hl{Les
données publiées par la Banque nationale de Belgique couvrent des maturités allant jusqu'à
30~ans. + date qu on a pris pour les taux}

\hl{Pour les durées résiduelles supérieures à 30~ans, le taux OLO à 30~ans est
retenu par convention.}

\hl{dire que on part du principe que taux olo sont réinvesti au même taux par capitalisation}
...
\hl{justifier que 30 pourcents impots sur intérêt olo }
