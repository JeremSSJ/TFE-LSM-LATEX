...
fixons nous-mêmes les niveaux selon deux configurations. Dans le scénario à frais
...
Dans le scénario à
frais majorés, nous les alignons sur les moyennes retenues pour
les contrats d'assurance-vie. Cette convention établit une borne conservative sans
désavantager excessivement l'un des deux véhicules et compense aussi les frais de gestion
des ETF.

\hl{plutot dire qu on a pas accès à des moyennes transparentes de source
officielle comme pour assurance vie + dans tous les cas on veut juste voir la tendace}
