...
de type accumulant pour éviter de modéliser une fiscalité sur les distributions de dividendes \cite{curvo_capitalisant_distribuant_2026}. 
Ce type
...
Nous supposons des frais d'entrée et de gestion fixes dans un scénario donné, dont nous
...
(e.g. Trade Republic \footnote{\url{https://www.traderepublic.com/fr-be}}). 
...
et d'un référentiel de capitalisation stable sur l'ensemble de la simulation \footnote{.}.

\hl{30 max pour olo et donc au dessus de 30 on garde 30}
