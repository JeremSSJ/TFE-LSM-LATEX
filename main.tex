...
actualisé plutôt que capitalisé.
\begin{align}
  \text{CFN}_{\text{B23}} &=
    \underbrace{%
      C_N^{\text{net}}
...
\begin{quote}
\textit{Exemple~: Antoine reçoit 300~€ de remboursement chaque année. Le
premier remboursement, encaissé en année~1 pour le versement de l'année~0,
est capitalisé sur les 34~années restantes~; le dernier remboursement,
correspondant au versement de l'année~35, est perçu en année~36, soit un
