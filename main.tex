...
Les résultats sont visualisés sous forme de heatmaps bidimensionnelles \ref{sec:resultats_elt} dont
...
l'âge de début des versements (de 18 à 55~ans) \ref{subsec:limites-methodo}. Chaque cellule indique
...
\begin{itemize}
  ...
  \item Quatre configurations fiscales \ref{sub:scenarii_fiscaux};
  \item Trois scénarios de frais \ref{sub:scenarii_frais}.
\end{itemize}
...
prélèvement~: les frais d'entrée. Pour l'épargne-pension,
