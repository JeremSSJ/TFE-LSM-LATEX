...
\begin{enumerate}[label=\alph*)]
  \item Rendement annuel brut constant. Le taux de rendement est supposé identique
  ...
  \item Versements annuels constants. Les versements sont annuels et identiques d'une
  ...
  \item Effort d'épargne constant jusqu'à l'échéance. La simulation exclut tout rachat
  ...
  \item Horizon commun fixé à 65~ans. Le régime fiscal de l'épargne-pension prévoit que
  ...
  \item Âge de début plafonné à 55~ans. La simulation n'inclut que des profils dont les
  ...
  \item Portefeuille entièrement investi en actions via un ETF accumulant. L'investisseur
  ...
  \item Abstraction du spread et des coûts d'exécution. Lors de chaque transaction,
  ...
  \item Frais constants par scénario. Les frais d'entrée et de gestion sont fixes dans un
    scénario donné~; leur évolution dans le temps n'est pas modélisée.

  \item Taxe sur les comptes-titres couverte par les frais de gestion de la branche~23.
  ...
  \item Fiscalité figée au moment de la rédaction. La réglementation fiscale est celle en
    vigueur au moment de la rédaction. Tout changement législatif futur n'est pas pris en
    compte.

  \item Comparaison en capital final net à l'échéance. La comparaison est conduite en
  ...
  \item Absence de risque de contrepartie. Les deux instruments sont supposés exempts de
    tout risque de défaut ou de faillite de l'assureur ou du courtier.

  \item Méthode d'exonération des plus-values simplifiée. L'exonération des plus-values
