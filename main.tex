...
\url{https://www.bfmtv.com/economie/patrimoine/placements-epargne/la-france-est-la-championne-d-europe-des-etf-chez-les-jeunes-apres-une-explosion-de-117-cette-annee-le-nombre-de-detenteurs-francais-devrait-depasser-les-4-millions-fin-2026_AV-202512290023.html}
...
\url{https://www.youtube.com/@gregoryguilmin}
\url{https://www.youtube.com/@matthiasbaccino}
\url{https://ch.zonebourse.com/actualite-bourse/Trade-Republic-rend-accessible-l-investissement-fractionne-et-franchit-une-nouvelle-etape-cle-d-41933267/}
...
\url{https://curvo.eu/fr/article/etf-vs-epargne-pension}
...
\hl{source ne dit pas que pris avant, mais la suivante si}
...
\hl{Cette
limite d'âge est déterminante : seuls les versements effectués dans
...
toute activité professionnelle \cite[p.~4-5]{chambre2025pv_actifs}.
...
15\,000~euros \cite[p.~9]{chambre2025pv_actifs}. \colorbox{red}{keep}

Les actifs financiers relevant de l'épargne-pension et de
l'épargne à long terme sont toutefois exclus de ce nouvel
impôt \cite[p.~39]{chambre2025pv_actifs}. \colorbox{red}{keep}
...
et long terme comme exemple via le fond vivium

, et qu on en prend bien diversifié 
...
mais je pense que je ne vais pas prendre le TER car je veux isoler plutot les frais 
du compte titres et comme on égalise ceux ci au frais de la branche 23 qui sont 
plus élevés que ceux du marché on peut être faire abstraction de ceux ci même 
s ils réduisent directement le montant du capital accumulé}
...
\hl{ici retirer tct car on part du principe qu'inclue dans frais de gestion,
...
Le scénario de frais~B applique des frais \hl{revoir car belgique et ter on s en fout} représentatifs des conditions de marché
...
2.83\,\%\cite[p.~27]{fsma_couts_piliers}
2.34\,\%\cite[p.~30]{fsma_couts_piliers}
...
\hl{abstraction de frais de transaction, cours qui reste constant}
