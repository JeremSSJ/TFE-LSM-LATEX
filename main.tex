...
\subsection{L'essor de l'investissement individuel}

Au cours des dernières années, l'accès aux marchés financiers s'est profondément
démocratisé. Le développement de néocourtiers à frais réduits a rendu la détention
d'un compte-titres accessible à un public bien plus large qu'auparavant, tandis que
la popularisation des fonds indiciels cotés (ETF) a contribué à diffuser une culture
de l'investissement passif à long terme, fondée sur la diversification et la maîtrise
des coûts. Dans ce contexte, l'investisseur particulier belge qui souhaite se
constituer un capital en vue de la retraite se trouve confronté à un choix entre
plusieurs enveloppes de placement aux logiques très différentes.

\subsection{Les trois véhicules comparés}

Trois véhicules sont au cœur de cette étude. L'\textbf{épargne-pension} et
l'\textbf{épargne à long terme} sont deux enveloppes fiscales permettant la
constitution d'un capital complémentaire pour la retraite via des contrats
d'assurance-vie. Les primes versées ouvrent droit à une réduction d'impôt à l'entrée ;
en contrepartie, un prélèvement fiscal est opéré à la sortie sur les sommes
constituées. Ces produits peuvent prendre la forme de contrats de la branche~23,
dont la valeur est indexée sur la performance de fonds d'investissement sous-jacents.

Le \textbf{compte-titres}, quant à lui, permet à l'investisseur de détenir
directement des actifs financiers --- notamment des ETF --- sans enveloppe fiscale
dédiée. Son attrait résidait historiquement en grande partie dans l'absence de
taxation des plus-values réalisées par les particuliers gérant leur patrimoine privé
dans le cadre normal de celui-ci. Cette caractéristique a cependant été remise en
cause par une réforme fiscale majeure.

\subsection{Le tournant fiscal de 2026}

À compter du 1\textsuperscript{er} janvier 2026, le paysage fiscal de l'investissement
particulier en Belgique a été profondément modifié. La loi du 17~décembre~2025
introduisant un impôt sur les plus-values des actifs financiers instaure une taxation
de 10\,\% sur les plus-values réalisées lors de la cession d'actifs financiers en
dehors de toute activité professionnelle, après exonération d'une première tranche
annuelle de 10\,000~euros \cite[p.~4-5, 9]{chambre2025pv_actifs}. Ce changement
modifie structurellement la rentabilité nette du compte-titres et repose la question
de la comparaison avec les enveloppes fiscales avec une acuité renouvelée.

Les actifs relevant de l'épargne-pension et de l'épargne à long terme sont
explicitement exclus de ce nouvel impôt \cite[p.~39]{chambre2025pv_actifs}, ce qui
confère à ces enveloppes un avantage relatif supplémentaire par rapport à la
situation antérieure à 2026.

\subsection{Objet du travail}

C'est dans ce contexte que s'inscrit ce travail. Il s'agit de déterminer, pour un
particulier belge constituant un capital en vue de sa retraite, lequel des trois
véhicules --- épargne-pension, épargne à long terme ou compte-titres --- offre le
capital final net le plus élevé, et dans quelle mesure l'introduction de la taxe
sur les plus-values de 2026 modifie la hiérarchie entre eux. Pour répondre à cette
question, une simulation comparative est développée à rendement brut identique entre
les véhicules, en faisant varier les paramètres pertinents que sont le montant versé,
la durée de placement et la configuration fiscale.
...
\hl{évolution de la fiscalité, peut être stat pour assurance vie particuliers,
transposer la direction de taxe sur les plus values de compte titres à ici}
...
\hl{nous expliciterons dans ce chapitre l épargne pension et épargne long terme}
